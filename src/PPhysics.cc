...
void PPhysics::GoosyNewFPDRecabledYoke(TH1* hist)
{
    TH1* temp = (TH1D*) hist->Clone("temp");
    ...
    Int_t yoke[10] = {376, 60, 252, 124, 316, 188, 380, 354, 28, 92};
    while (i < nTagg)
    {
...
void PPhysics::GoosyNewFPDRecabledYokeOR(TH1* hist)
{
    TH1* temp = (TH1D*) hist->Clone("temp");
