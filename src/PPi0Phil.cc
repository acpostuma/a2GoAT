...
void	PPi0Phil::ProcessScalerRead()
{
  // Fill Tagger Scalers
  FillScalers(GetTC_scaler_min(),GetTC_scaler_max(),TaggerAccScal);
}

Bool_t	PPi0Phil::Write()
{
  // Write all GH1's and TObjects defined in this class
  return GTreeManager::Write();
}

void PPi0Phil::FillMassMissingMass(const GTreeParticle& tree, GH2* gHist, Bool_t TaggerBinning)
{
...
void PPi0Phil::FillMassMissingMass(const GTreeParticle& tree, Int_t particle_index, GH2* gHist, Bool_t TaggerBinning)
{
...
void PPi0Phil::FillMassMissingMass(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, GH2* gHist, Bool_t TaggerBinning)
{
